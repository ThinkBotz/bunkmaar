                  ...
                  <TableRow>
                    ...
                    {timetable.schedule.map((day) => (
                      <TableHead key={day.day} className="text-center px-1 sm:px-4">
                        <div className="text-[9px] sm:text-sm font-semibold">{day.day.slice(0,3)}</div>
                      </TableHead>
                    ))}
                  </TableRow>
                </TableHeader>
                  ...
                  {timetable.schedule[0]?.timeSlots.map((_, slotIndex) => (
                    <TableRow key={slotIndex} className="hover:bg-muted/50">
                      ...
                      {timetable.schedule.map((day) => {
                        ...
                        return (
                          <TableCell key={`${day.day}-${slot.id}`} className="text-center p-0.5 sm:p-2">
                            <Badge
                              variant="secondary"
                              className="text-[8px] sm:text-xs font-medium text-white w-full justify-center py-0.5 px-0.5 sm:px-2 whitespace-nowrap"
                              style={{
